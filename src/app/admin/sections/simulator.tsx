...
const s: Record<string, React.CSSProperties> = {
  liveBar: { display: 'flex', gap: T.spacing[4], alignItems: 'center', flexWrap: 'wrap', marginBottom: T.spacing[4], padding: `${T.spacing[3]} ${T.spacing[4]}`, background: T.colors.bgSurface, border: `${T.borders.thin} solid ${T.colors.borderSubtle}`, borderRadius: T.radius.lg },
  ...
  input: { width: '100%', background: T.colors.bgTertiary, border: `${T.borders.thin} solid ${T.colors.borderSubtle}`, borderRadius: T.radius.sm, padding: `${T.spacing[2]} ${T.spacing[3]}`, color: T.colors.textPrimary, fontSize: T.fontSizes.sm, fontFamily: 'inherit' },
  presetRow: { display: 'flex', gap: T.spacing[2], marginBottom: T.spacing[3], flexWrap: 'wrap' },
  presetBtn: { padding: `${T.spacing[2]} ${T.spacing[3]}`, borderRadius: T.radius.sm, fontSize: T.fontSizes.micro, fontWeight: T.fontWeights.bold, cursor: 'pointer', border: `${T.borders.thin} solid ${T.colors.borderSubtle}`, background: 'transparent', color: T.colors.textSecondary, transition: `all ${T.transitions.fast}` },
  ...
  range: { flex: 1, border: T.borders.none, width: '100%' },
  ...
  profitTh: { textAlign: 'left', padding: T.spacing[1], color: T.colors.textSecondary, borderBottom: `${T.borders.thin} solid ${T.colors.borderSubtle}`, fontWeight: T.fontWeights.bold, fontSize: T.fontSizes.micro },
  profitTd: { padding: T.spacing[1], borderBottom: `${T.borders.thin} solid ${T.colors.borderSubtle}` },
  profitInput: { width: T.spacing[12], background: T.colors.bgTertiary, border: `${T.borders.thin} solid ${T.colors.borderSubtle}`, borderRadius: T.radius.sm, padding: `${T.spacing[1]} ${T.spacing[1]}`, color: T.colors.textPrimary, fontSize: T.fontSizes.micro, textAlign: 'center', fontFamily: MONO },
  profitSelect: { background: T.colors.bgTertiary, border: `${T.borders.thin} solid ${T.colors.borderSubtle}`, borderRadius: T.radius.sm, padding: `${T.spacing[1]} ${T.spacing[1]}`, color: T.colors.textPrimary, fontSize: T.fontSizes.micro },
  btnSm: { padding: `${T.spacing[1]} ${T.spacing[2]}`, fontSize: T.fontSizes.micro, background: 'transparent', border: `${T.borders.thin} solid ${T.colors.borderSubtle}`, color: T.colors.textSecondary, borderRadius: T.radius.sm, cursor: 'pointer' },
  tabs: { display: 'flex', gap: T.spacing[2], marginBottom: T.spacing[3] },
  tab: { padding: `${T.spacing[2]} ${T.spacing[3]}`, borderRadius: T.radius.sm, fontSize: T.fontSizes.xs, fontWeight: T.fontWeights.bold, cursor: 'pointer', border: `${T.borders.thin} solid ${T.colors.borderSubtle}`, background: 'transparent', color: T.colors.textSecondary, transition: `all ${T.transitions.fast}` },
  ...
  pocketRow: { display: 'flex', alignItems: 'center', gap: T.spacing[2], padding: `${T.spacing[2]} 0`, borderBottom: `${T.borders.thin} solid ${T.colors.borderSubtle}` },
  ...
  compTh: { textAlign: 'left', padding: T.spacing[2], color: T.colors.textSecondary, borderBottom: `${T.borders.thin} solid ${T.colors.borderSubtle}`, fontWeight: T.fontWeights.bold },
  compTd: { padding: T.spacing[2], borderBottom: `${T.borders.thin} solid ${T.colors.borderSubtle}`, color: T.colors.textPrimary },
}
